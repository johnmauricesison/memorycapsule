...
SECRET_KEY = 'django-insecure-#_=@5fzrn26ctah&@0$!ragf41w$6y99shp_s-z)6k39#%z+k+'
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': False,                   # Do not auto-rotate refresh tokens
    'BLACKLIST_AFTER_ROTATION': True,                 # Blacklist tokens after rotation
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'your-secret-key',                 # Use a secret key for signing JWTs
}
